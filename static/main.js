...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n// 비로그인일 때 모달창이 뜨고 그 후에 로그인하고 나서 다시 그 페이지로 돌아오게 하는것\n// 조인은 안돌아옴\n\nvar modalBlock = document.getElementById('jsModalBlock');\nvar videoLikeBtn = document.getElementById('jsVideoLikeBtn');\nvar videoDislikeBtn = document.getElementById('jsVideoDislikeBtn');\nvar commentInput = document.getElementById('jsCommentInput');\nvar modalOverlay = document.getElementById('jsModalLayout');\nvar modalLoginBtn = document.getElementById('jsModalLoginBtn');\nvar modalJoinBtn = document.getElementById('jsModalJoinBtn');\n\nfunction goLogin(_x) {\n  return _goLogin.apply(this, arguments);\n}\n\nfunction _goLogin() {\n  _goLogin = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(comebackUrl) {\n    var response;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default()({\n              method: 'get',\n              url: \"/login?\".concat(comebackUrl)\n            });\n\n          case 2:\n            response = _context.sent;\n\n          case 3:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n  return _goLogin.apply(this, arguments);\n}\n\nfunction handleLogin() {\n  var location = window.location.href;\n  var comebackUrl = location.split('?')[0];\n  goLogin(comebackUrl);\n}\n\nfunction handleJoin() {}\n\nfunction handleModal() {\n  modalBlock.classList.remove('hidden');\n}\n\nfunction exitModal() {\n  modalBlock.classList.add('hidden');\n}\n\nfunction init() {\n  var userObj = document.getElementById('jsCommentForm').dataset.user;\n  console.log(userObj);\n\n  if (!userObj) {\n    videoLikeBtn.addEventListener('click', handleModal);\n    videoDislikeBtn.addEventListener('click', handleModal);\n    commentInput.addEventListener('focus', handleModal);\n    modalOverlay.addEventListener('click', exitModal);\n    modalLoginBtn.addEventListener('click', handleLogin);\n    modalJoinBtn.addEventListener('click', handleJoin);\n  }\n}\n\nif (modalBlock) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/modalBlock.js?");

/***/ }),

/***/ "./assets/js/videoPlayTimeFormat.js":
/*!******************************************!*\
  !*** ./assets/js/videoPlayTimeFormat.js ***!
  \******************************************/
/*! exports provided: playtimeFormatter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"playtimeFormatter\", function() { return playtimeFormatter; });\n// const videoPlayer = document.getElementById('jsVideoPlayer');\nvar playtimeFormatter = function playtimeFormatter(playtime) {\n  var hour, min, sec;\n\n  if (playtime >= 3600) {\n    //hour:min:sec\n    hour = Math.floor(playtime / 3600);\n    var tmp = playtime % 3600;\n    min = Math.floor(tmp / 60);\n    sec = tmp % 60;\n    return \"\".concat(hour, \":\").concat(min < 10 ? \"0\".concat(min) : min, \":\").concat(sec < 10 ? \"0\".concat(sec) : sec);\n  } else if (playtime >= 60) {\n    //min:sec\n    min = Math.floor(playtime / 60);\n    sec = Math.floor(playtime % 60);\n    return \"\".concat(min < 10 ? \"0\".concat(min) : min, \":\").concat(sec < 10 ? \"0\".concat(sec) : sec);\n  } else {\n    //sec\n    sec = Math.floor(playtime);\n    return \"00:00:\".concat(sec < 10 ? \"0\".concat(sec) : sec);\n  }\n}; // function init() {\n//     playtimeFormatter();\n// }\n// if (videoPlayer) {\n//     init();\n// }\n\n//# sourceURL=webpack:///./assets/js/videoPlayTimeFormat.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! E:\\GitRepositories\\wetube\\assets\\js\\main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");
